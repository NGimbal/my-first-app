...
Nick's first app... there will be a viewer.
...
```
> pollination-apps deploy . --name "My First App" --public
```
...
Github actions will then package and deploy your code to an app called [My First App](https://app.pollination.cloud/nicolas/applications/my-first-app)
